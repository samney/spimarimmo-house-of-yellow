...
export function ConsentBanner() {
  ...
  return (
    ...
    >
      ...
      {/* The /cookies route exists again and states honestly that no policy is
          published yet (LEG-1 remains open until SPIMAR-authored legal text is
          approved). Linking to that is correct; linking to a 404 — which is
          what TRF-004 left behind — was not. The E2E suite asserts every link
          this banner renders resolves. */}
