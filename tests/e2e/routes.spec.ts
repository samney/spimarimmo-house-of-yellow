...
/* French is the default locale (`e1500dd`), so "/" IS French and the explicit
   "/fr" prefix canonicalizes to it. English is the prefixed locale. This is the
   inverse of the pre-SPIMAR arrangement the reference clone shipped with. */
...
/* Re-homed from the deleted works/project-detail specs. Those carried the only
   ...
   `.claude/rules/frontend-quality.md`'s "no horizontal overflow" rule with no
