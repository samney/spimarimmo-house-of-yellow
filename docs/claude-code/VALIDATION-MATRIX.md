...
| `ENG-014E` | Motion, focus, keyboard, reduced motion, axe, overflow, browser and visual-diff evidence at eight viewports; **must re-measure and then resolve or formally reassess the `D-014` global-shell whole-page height exception (`PAR-P1-004`: desktop 203px×20 records / 202px×1, mobile 194px×18 / 195px×3) before `ENG-015` freeze** |
