...
canonical_for: cms-implementation
depends_on:
...
Set `CMS_CAPABILITY_ACCEPTED=true` only when this journey passes with retained evidence. Provider selection, production integration, and release remain separate gates under [`../governance/ACCEPTANCE-LEVELS.md`](../governance/ACCEPTANCE-LEVELS.md).
