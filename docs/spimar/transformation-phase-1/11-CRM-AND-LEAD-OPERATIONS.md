...
canonical_for: crm-and-lead-operations
depends_on:
...
Set `CRM_CAPABILITY_ACCEPTED=true` only when this complete journey passes. Provider selection, production integration, and release remain separate gates under [`../governance/ACCEPTANCE-LEVELS.md`](../governance/ACCEPTANCE-LEVELS.md).
