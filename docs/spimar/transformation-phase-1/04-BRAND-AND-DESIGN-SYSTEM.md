...
canonical_for: brand-and-design-system
depends_on:
...
The accepted House of Yellow foundation and frozen parity evidence are used as a craft reference. The [live site](https://houseofyellow.nl/) is informational only because it can change. Reference-derived lessons include:
