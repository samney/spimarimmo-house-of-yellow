...
canonical_for: traceability-matrix
depends_on:
...
Exact paths and hashes are controlled by [`../governance/SOURCE-MANIFEST.md`](../governance/SOURCE-MANIFEST.md). The strategic PDF page-level crosswalk is [`../governance/PDF-SPECIFICATIONS-CROSSWALK.md`](../governance/PDF-SPECIFICATIONS-CROSSWALK.md).

| Controlling input                                                      | Phase 1 use                                                                                                    | Package files                    |
| ---------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------- |
| Original and redesigned SPIMARIMMO strategic/UX/content specifications | B2B north star, audiences, homepage, event/exhibitor/visitor content, evidence, and documentation presentation | 00, 01, 05-09 plus PDF crosswalk |
