...
| Event children | `programme`, `exposants`, `pratique`, `galerie` | detailed event information | conditional index |
| Exhibit | `/{locale}/exposer` | why exhibit, method, proof, role-based objections | index |
| Offers | `/{locale}/offres` | controlled Standard/Premium/Sponsor comparison | conditional index |
| Proof | `/{locale}/preuves`, `/cas`, `/cas/{slug}` | metrics, cases, partners, testimonials | conditional index |
