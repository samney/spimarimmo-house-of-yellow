  ...
  return (
    <>
      ...
      <div className="adminSplit">
        <section className="adminPanel" aria-label="Asset editor">
        ...
        <section className="adminPanel" aria-label="All assets">
          <h2>
            All assets <span className="adminCount">· {rows.length}</span>
          </h2>
          {rows.length === 0 ? (
            <div className="adminEmpty">
              No media asset has been recorded yet. Record one on the left with its rights and
              provenance.
            </div>
          ) : (
                ...
                <tbody>
                  {rows.map((m) => (
                    <tr key={m.id}>
                      ...
                      <td>{m.rightsOwner || "—"}</td>
                      <td>
                        <span className={`adminChip adminChip--${m.state}`}>{m.state}</span>
                      </td>
                      <td>
