...
- **Review discipline, review tiers, and merge authority:** the `Delivery discipline` section
  of `AGENTS.md` — read it live; the tiering model has been superseded before and will be
...
- **Operating boundaries and authority order:** `AGENTS.md`
...
2. Read the `Delivery discipline` section of `AGENTS.md` and classify this change. Note
